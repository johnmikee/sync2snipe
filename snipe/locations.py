class Locations:
    ...
    def get_location_detail(self, location_id: int) -> dict:
        """
    ...
    def update_location(
        self, method: str, location_id: int, name: str, **kwargs
    ) -> dict:
        """
        ...
        return self._requester(method.upper(), f"locations/{location_id}", json=payload)
