class Fields:
    ...
    def get_field_by_id(self, field_id: int) -> dict:
        """
        https://snipe-it.readme.io/reference/fieldsid
        """
        return self._requester("GET", f"fields/{field_id}")

    def update_custom_field(self, field_id: int, name: str, element: str) -> dict:
        """
    ...
    def associate_custom_field(self, field_id: int, fieldset_id: int) -> dict:
        """
    ...
    def remove_custom_field_association(self, field_id: int, fieldset_id: int) -> dict:
        """
        https://snipe-it.readme.io/reference/fieldsidassociate
        """
        payload = {"fieldset_id": fieldset_id}
...
class FieldSets:
    ...
    def update_fieldset(self, fieldset_id: int, name: str) -> dict:
        """
